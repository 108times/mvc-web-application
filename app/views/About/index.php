  <div class="hero-wrap hero-bread" style="background-image: url('<?=IMG?>bg_1.jpg');">
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(<?=IMG?>about.jpg);">
	...
	<!-- End Features Section -->
		...
		<section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(<?=IMG?>daydeal.jpg);">
    	<div class="container">
