                ...
                <?php foreach($blog as $item): ?>
				 <div class="col-md-12 d-flex ftco-animate">
		            <div class="blog-entry align-self-stretch d-md-flex">
		              <a href="blog-single.html" class="block-20" style="background-image: url('<?=IMG.$item['img']?>');">
		              </a>
		              <div class="text d-block pl-md-4">
		                ...
		                <p><a href="<?= BLOG . 'view/' . $item['alias']?>" class="btn btn-primary py-2 px-3">Read more</a></p>
		              </div>
		            </div>
		          </div>
                <?php endforeach; ?>
