    	...
    	<div class="container">
    		<div class="row">
    			...
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				...
    				<p class="price">
                    <?php $price = @floatval($product['price']); ?>
                    <?php $old_price = @floatval($product['old_price']); ?>
                    <span><?= $curr['symbol_left'] ."". ($price * $curr['value']) . " " . $curr['symbol_right'] ?> <span class="old_price"><small><?= $curr['symbol_left'] ."". ($old_price * $curr['value']) . " " . $curr['symbol_right']?></small></span></span>
                    </p>
